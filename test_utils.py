...
class TestUtils(unittest.TestCase):
    ...
    def test_load_img_tensor_from_path(self):
        ...
        """
        test_image_tensor = utils.load_img_tensor_from_path('./test_image.png')
        actual_test_image_tensor = tf.convert_to_tensor(np.load('actual_test_image_tensor.npy'), dtype=tf.float32)
